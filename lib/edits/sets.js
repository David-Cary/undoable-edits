...
var UndoableSetHandler = /** @class */ (function (_super) {
    ...
    function UndoableSetHandler() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    UndoableSetHandler.prototype.get = function (target, property) {
        if (this.onChange != null) {
            var onChange_1 = this.onChange;
            switch (property) {
                case 'add': {
                    return function (value) {
                        onChange_1(new UndoableAddSetItem(target, value));
                        return target.add(value);
                    };
                }
                case 'clear': {
                    return function () {
                        onChange_1(new UndoableClearSet(target));
                        target.clear();
                    };
                }
                case 'delete': {
                    return function (value) {
                        onChange_1(new UndoableDeleteSetItem(target, value));
