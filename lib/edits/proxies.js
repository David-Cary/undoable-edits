...
exports.UndoableTransformation = exports.applyUndoableActionVia = exports.unwrapProxyTarget = exports.createUndoableProxy = exports.ClassedUndoableProxyFactory = exports.UndoableProxyHandler = exports.APPLY_UNDOABLE_ACTION = exports.PROXY_TARGET = exports.PROXY_HANDLER = void 0;
...
var UndoableProxyHandler = /** @class */ (function () {
    ...
    UndoableProxyHandler.prototype.onChange = function (change) {
        for (var _i = 0, _a = this.actionCallbacks; _i < _a.length; _i++) {
            var callback = _a[_i];
            callback(change);
        }
    };
