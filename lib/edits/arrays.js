...
var UndoableArrayHandler = /** @class */ (function (_super) {
    ...
    function UndoableArrayHandler(onChange, deep, recordHandler) {
        if (deep === void 0) { deep = false; }
        var _this = _super.call(this, onChange) || this;
        _this.deep = deep;
        _this.recordHandler = recordHandler !== null && recordHandler !== void 0 ? recordHandler : new objects_1.UndoableRecordHandler(onChange, deep, _this);
        return _this;
    }
